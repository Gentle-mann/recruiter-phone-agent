...
export const CONTENT: Record<string, Pack> = {
  be: {
    ...
    q: [
      ["This is a full-time role, and we need authorization to work in the United States. Does that work for you?", "Yes. Full-time, and I am authorized to work in the US."],
      ["On your resume you mentioned you re-architected the payments ledger. What was breaking before, and what did you personally own?", "The ledger. We started with one Postgres table and row locks. At about 40k writes a minute the locks were the bottleneck, so I split hot accounts into shards and moved reconciliation to a nightly job. I owned the design and the cutover."],
    ],
    note: [
      "Confirmed eligibility, then walked through the ledger: row locks, sharding, personal ownership of the cutover.",
      "Eligibility was a yes. The ledger follow-up was vague on what was breaking and what they owned.",
      "Authorized and available, but could not name a concrete failure on the ledger.",
      "Talked fast and in generalities. Could not explain the résumé claim.",
    ],
    titles: ["Senior Backend Engineer", "Backend Engineer", "Staff Engineer", "Software Engineer II"],
    rubric: [
      ["Full-time and US work authorization", "must", "call", ["Confirmed full-time and authorized to work in the US.", "Authorized, but hedged on full-time.", "Did not confirm full-time or US work authorization."]],
      ["Payments ledger ownership", "must", "call", ["Named what was breaking on the ledger and what they personally owned.", "Talked about the ledger, but ownership or the failure mode was vague.", "Could not explain what was breaking or what they personally owned."]],
      ["5+ years backend", "must", "résumé", ["{yrs} years across two companies, the last three at {company}.", "{yrs} years, but most of it full-stack with light backend.", "Résumé does not show 5+ years of backend work."]],
      ...
      ["Go or Rust", "nice", "résumé", ["Go daily for four years.", "Some Go, mostly Python.", "Neither mentioned on the application or the call."]],
      ["Payments domain", "nice", "résumé", ["Two years on {area} at {company}.", "Adjacent: billing reconciliation tooling.", "None on the application or the call."]],
    ],
    ...
    strengths: ["Confirmed full-time and US work authorization on the call.", "Walked through what was breaking on the ledger and what they personally owned.", "Postgres depth is real, backed by public repos."],
    concerns: ["Did not ask any questions about the role.", "Salary expectation is at the top of the band."],
