...
export const TZ: Record<string, string> = { Lisbon: "GMT+1", Berlin: "GMT+2", London: "GMT+1", Toronto: "GMT-4", Austin: "GMT-5", Amsterdam: "GMT+2", "São Paulo": "GMT-3", Singapore: "GMT+8", Warsaw: "GMT+2", Dublin: "GMT+1", "New York": "GMT-4", Lagos: "GMT+1", Tokyo: "GMT+9", Madrid: "GMT+2", Stockholm: "GMT+2", Bangalore: "GMT+5:30" };
